...
class ModularAMG1C(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModularAMG1C")
        ...
        self._K_win = RangeWidget(self._K_range, self.set_K, "'K'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "amplitu portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.CalculoPotencia_J1C_04_0, 0))
...
def main(top_block_cls=ModularAMG1C, options=None):
