...
from DSBSC import DSBSC  # grc-generated hier_block
...
class TransmisorQAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_gain(GTX, 0)
        ...
        self.blocks_wavfile_source_0_0 = blocks.wavfile_source('/home/labcom/Comm_G1C_4/despecha_rosalia.wav', True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Comm_G1C_4/despecha_rosalia.wav', True)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.audio_sink_0 = audio.sink(200000, '', True)
        ...
        # Connections
        ##################################################
        self.connect((self.DSBSC_0, 0), (self.uhd_usrp_sink_0, 0))
        ...
        self.connect((self.blocks_wavfile_source_0_0, 0), (self.rational_resampler_xxx_1, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.DSBSC_0, 0))
        self.connect((self.rational_resampler_xxx_1, 0), (self.DSBSC_0, 1))
    ...
    def set_GTX(self, GTX):
        ...
        self.uhd_usrp_source_0.set_gain(self.GTX, 0)
