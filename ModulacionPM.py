...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "MOdulaciòn PM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MOdulaciòn PM")
        ...
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "Ampitud portadora", "counter_slider", float, QtCore.Qt.Horizontal)
